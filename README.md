...
内置第一、二阶段共 48 周完整数据（约 290 个词项，来自 `english-learning-plan.md`），以及 26 字母、6 组自然拼读、4 组高频词的 ABC 基础数据。多阶段结构，周号 1–48 连续，家长中心进度表按阶段分组展示。
...
├── index.html                 # 入口
├── assets/
│   ├── data.js                # 学习内容数据（第一、二阶段 48 周 + ABC 基础数据）
